  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Ajouter une Villa</h3>
        ...
        <div class="row mt">
          <div class="col-lg-12">
            ...
            <div class="form-panel">
              <div class="form">
                <form class="cmxform form-horizontal style-form" id="signupForm" method="post" action="{{ route('proprietaire.storeVilla') }}" enctype="multipart/form-data">
                  @csrf
                  <div class="form-group ">
                    <label for="firstname" class="control-label col-lg-2">Le nom du villa</label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="firstname" name="libele" type="text" />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="lastname" class="control-label col-lg-2">Le nombre de pièces</label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="lastname" name="nombre_piece" type="number" />
                    </div>
                  </div>
                  <div class="form-group ">
                  ...
                  <div class="form-group ">
                    <label for="email" class="control-label col-lg-2">Le quartier ou se trouve le villa</label>
                    <div class="col-lg-10">
                  ...
                  <div class="form-group ">
                    <label for="email" class="control-label col-lg-2">Le proprétaire du villa</label>
                    <div class="col-lg-10">
