        ...
        <div class="chat-room mt">
          <aside class="mid-side">
            ...
            @foreach ($studios as $studio) 
              <div class="room-box" style="font-size: 25px">
                <h3 class="text-primary"> {{$studio->libele}} </h3>
                <p>Cette studio occupe une supérficie de {{$studio->superficie}}</p>
                <p><span class="text-muted">Nombre de piéces :</span> {{$studio->nombre_piece}} <span class="text-muted">. Il se trouve dans l'immeuble :</span> {{$studio->immeuble->libele}} </p>
              </div>
            @endforeach
            </div>
          ...
          <aside class="right-side">
            ...
            <div class="invite-row">
              <h4 class="pull-left">Nos studios </h4>
            </div>
            <h1 class="text-center">Bienvenue <br><br> sur le lot de nos <br><br> studios bien décorés </h1>
          </aside>
        </div>
        <!-- page end-->
      </section>
