          ...
          <aside class="mid-side">
            ...
            @foreach ($bureaus as $bureau) 
              <div class="room-box" style="font-size: 25px">
                <h3 class="text-primary"> {{$bureau->libele}} </h3>
                <p>Cette bureau occupe une supérficie de {{$bureau->superficie}}</p>
                <p><span class="text-muted">Il se trouve dans l'immeuble :</span> {{$bureau->immeuble->libele}} </p>
              </div>
            @endforeach
            </div>
